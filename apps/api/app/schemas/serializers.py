...
def serialize_report(report: Report, *, viewer: User | None = None, include_private: bool = False) -> dict[str, Any]:
    ...
    return {
        ...
        "reporter_name": report.reporter.full_name if getattr(report, "reporter", None) else None,
        "assigned_worker_name": report.assigned_worker.full_name if getattr(report, "assigned_worker", None) else None,
    }
