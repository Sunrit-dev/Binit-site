...
export default function SignInPage() {
  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center bg-surface-950 px-4 py-10 text-[#ecf8f1]">
      ...
      <div className="relative z-[1] w-full max-w-2xl">
        ...
        <div className="text-center">
          <span className="relative mx-auto mb-5 flex size-14 items-center justify-center overflow-hidden rounded-2xl bg-gradient-primary font-display text-2xl font-black text-white shadow-glow-forest">
            B
