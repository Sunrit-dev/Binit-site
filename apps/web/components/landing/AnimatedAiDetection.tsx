      ...
      <div className="relative aspect-[16/9] overflow-hidden rounded-2xl border border-white/8 bg-[#06150f]">
        ...
        {ZONE_RINGS.map((z, i) => (
          ...
          >
            ...
            <span className="absolute -top-并能 flex items-center gap-1 rounded-full px-2 py-0.5 text-[9px] font-bold text-white" style={{ background: z.color, left: "30%", opacity: 0.65 }}>
              {z.label}
            </span>
          </div>
        ))}
